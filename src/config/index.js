...
module.exports = {
  ...
  pipeline: {
    vadThreshold: Number(process.env.VAD_THRESHOLD) || 0.007,
    speechStartChunks: Number(process.env.SPEECH_START_CHUNKS) || 1,
    ...
    minUtteranceBytes: Number(process.env.MIN_UTTERANCE_BYTES) || 2400,
